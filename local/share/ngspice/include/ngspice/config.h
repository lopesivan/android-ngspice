...
#define NGSPICEBINDIR "/data/data/com.octave/freeRoot/usr/local/bin"

/* Define the build date */
#define NGSPICEBUILDDATE "Thu Sep 19 00:02:06 SAST 2013"

/* Define the directory for architecture independent data files */
#define NGSPICEDATADIR "/data/data/com.octave/freeRoot/usr/local/share/ngspice"
